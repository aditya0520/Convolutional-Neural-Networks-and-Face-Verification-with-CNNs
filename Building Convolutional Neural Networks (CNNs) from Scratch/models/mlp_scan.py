...
class CNN_SimpleScanningMLP():
    ...
    def init_weights(self, weights):
        ...
        w1_transposed = w1.T 
        self.conv1.conv1d_stride1.W = w1_transposed.reshape(8, 8, 24).transpose(0, 2, 1)  # Final shape: (8, 24, 8)
        
        
        w2_transposed = w2.T  
        self.conv2.conv1d_stride1.W = w2_transposed.reshape(16, 1, 8).transpose(0, 2, 1)  # Final shape: (16, 8, 1)
        
        
        w3_transposed = w3.T 
        self.conv3.conv1d_stride1.W = w3_transposed.reshape(4, 1, 16).transpose(0, 2, 1)   # Final shape: (4, 16, 1)
...
class CNN_DistributedScanningMLP():
    def __init__(self):
        ...
        # Add layers with ReLU activations
    ...
    def init_weights(self, weights):
        ...
        self.conv1.conv1d_stride1.W = w1_transposed.reshape(2, 2, 24).transpose(0, 2, 1)  # Final shape: (2, 24, 2)
        
        
        w2_transposed = w2[:4,:8].T  
        self.conv2.conv1d_stride1.W = w2_transposed.reshape(8, 2, 2).transpose(0, 2, 1)  # Final shape: (8, 2, 2)
        
        
        w3_transposed = w3.T 
        self.conv3.conv1d_stride1.W = w3_transposed.reshape(4, 2, 8).transpose(0, 2, 1)   # Final shape: (4, 8, 2)
